        # Enma Snma: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/enma-snma.git

        ## Objective

        ENMA-SNMA implements Extended and Simplified NMA methods, providing accessible network meta-analysis workflows with full uncertainty quantification.
        ...
        - Code: https://github.com/mahmood726-cyber/enma-snma.git
        - Dashboard: https://mahmood726-cyber.github.io/enma-snma/
